...
import { Shield, Mail, ArrowRight, Loader2, Info, User } from 'lucide-react'
...
export function SignupPage() {
  ...
  const handleEmailSignup = async (e: React.FormEvent) => {
    ...
    setError('')
    try {
      // For mock simplicity, we log them in with email
      ...
      >
        ...
        <div className="mb-6 flex gap-2.5 p-3 rounded-lg bg-[#f59e0b]/5 border border-[#f59e0b]/20 text-[11px] leading-relaxed text-[#f59e0b] font-mono">
          ...
          <div>
            ...
            <p className="mt-0.5 opacity-80">Keys not configured. Registrations will run locally.</p>
          </div>
        </div>
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-xl font-display font-semibold text-white tracking-tight">Create Auditor profile</h1>
          <p className="text-[#8E8A9F] text-xs font-mono mt-1 uppercase">Register new credentials</p>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex items-center gap-3 py-2">
            ...
            <span className="text-[10px] font-mono text-[#8E8A9F] uppercase tracking-wider">or email signup</span>
            <div className="h-px bg-white/5 flex-1" />
          </div>
          ...
          <form onSubmit={handleEmailSignup} className="space-y-3">
            <div className="relative">
              ...
              />
              <User size={14} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[#8E8A9F]" />
            </div>
        ...
        <div className="mt-8 text-center text-[10px] font-mono text-[#8E8A9F]">
          ...
          <Link to="/login" className="text-[#D0FF00] hover:underline uppercase tracking-wide">Log In</Link>
        </div>
      </motion.div>
    </div>
  )
